            ...
            <div id="content">
             ...
             <div id="upload_box">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                    	<td>
                        	<span class="action" onclick="showHide_UploadnowBox()" >Carica nuovo file certificato</span>&nbsp;&nbsp;&nbsp;
                            <span class="action"><a href="filelist_only.php">Visualizza solo da certificare</a></span>
                        </td>
                    </tr>
                    <!--reply-->
                    <tr>
                        <td class="td_list"><span class="noaction">NOMEFILE</span></td>
                    	<td><span class="action">SCARICA</span></td>
