  ...
  <html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <body>
			...
			<img src="../image/admin_box/Sticker_hrimage.png" style="margin-left:30px;" />
             <div id="upload_box">
                 <p><span class="action"><a href="filelist.php">Visualizza tutti i file</a></span></p>
                    ...
                    <?php
                      ...
                      for($i=0; $i<$num_file; $i++){
                          ...
                          echo "  <tr>
                                    ...
                                    <td class=\"td_list, action\"><a href=\"segnala_certificato.php?id={$file['id_file_caricato']}\" onclick=\"javascript: return confirm('Sei sicuro di voler segnalare il file come certifico?');\">Segnala come Certificato</a></td>
                                  </tr>";
                      }
